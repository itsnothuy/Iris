...
sealed class IrisEvent {
    ...
    data class PerformanceProfileChanged(
        val profile: com.nervesparks.iris.common.config.PerformanceProfile,
    ) : IrisEvent()
    ...
    data class ErrorOccurred(
        val error: com.nervesparks.iris.common.error.IrisException,
